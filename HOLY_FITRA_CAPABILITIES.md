...
| Coding automation | Plan-first supervised agent, workspace confinement, allowlisted commands, transactional writes, rollback, improvement rounds, high-risk branch restrictions, and the HD copilot’s bounded Obsidian-compatible provenance retrieval | Unit tests and campaign dry-run gates; HD does not gain unrestricted control, background execution, external Obsidian synchronization, arbitrary shell/network access, or automatic apply authority |
