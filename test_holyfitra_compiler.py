...
"""
    ...
    def test_capabilities_report_has_explicit_evidence_boundaries(self):
        ...
        self.assertEqual(report["ai"]["deterministic_local_causal_baseline"], "byte_bigram_sparse_ngram_and_bounded_embedding_attention_training_checkpoint_generation_and_evaluation_host_validated")
